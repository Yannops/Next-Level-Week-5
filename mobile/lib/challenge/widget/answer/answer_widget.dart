...
class AsnwerWidget extends StatelessWidget {
  ...
  final bool disabled;
  const AsnwerWidget({Key? key, required this.answer, this.isSelected = false, required this.onTap, this.disabled = false}) : super(key: key);
        ...
        ignoring: disabled,
          ...
          onTap: onTap,
            ...
            child: Row(
              ...
              children: [
                Expanded(child: 
                Text(answer.title  , style: isSelected ? _selectedTextStyleRight : AppTextStyles.body)),
                Container(
                  width: 24,
                  height: 24,
                  decoration: BoxDecoration(
